...
class AC_Model(pl.LightningModule):
    ...
    def on_test_start(self):
        ...
        self.embedding_coreset_index_cpu = self.embedding_coreset_index
        self.embedding_coreset_with_edge_index_cpu = self.embedding_coreset_with_edge_index
    ...
    def test_step(self, batch, batch_idx): # Nearest Neighbour Search
        ...
        # with pymp.Parallel(8) as p :
        for k in range(self.embedding_coreset_with_edge_index.ntotal) :
